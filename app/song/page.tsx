              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="min-h-[120px] resize-none text-base mt-4 border rounded-lg p-4"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="min-h-[80px] resize-none text-base mt-2 border rounded-lg p-4"
                    disabled={isGenerating}
                  />
                                ...
                                (duration[clip.id] ||
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                      <div
                                        className="h-2 bg-gray-200 rounded-full cursor-pointer border"
                                        data-clip-id={clip.id}
                                        onClick={(e) =>
                                      ...
                                      >
                                        <div
                                          className="h-2 bg-blue-500 rounded-full pointer-events-none"
                                          style={{
                                        ...
                                        {/* Scrub handle */}
                                        <div
                                          className={`absolute top-1/2 w-4 h-4 bg-blue-600 rounded-full transform -translate-y-1/2 -translate-x-1/2 shadow-lg cursor-grab hover:bg-blue-700 select-none ${
                                            isDragging === clip.id
